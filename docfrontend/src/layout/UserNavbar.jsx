        ...
        <div className="flex items-center gap-4 -mt-2">
          <div className="relative inline-block group w-40">
            <Button bgColor="" textColor=""
              className={`flex items-center ${data === "Personal" ? 'pl-7' : 'pl-5'} py-2 w-41 text-white gap-1 rounded-md bg-blue-900`}>
              {data} Doc
              <svg
            ...
            <div className="absolute hidden group-hover:block bg-white w-41 border border-gray-200 shadow-lg">
              <Button className='px-4 w-full py-2 hover:bg-blue-200' bgColor='' textColor=''
                onClick={() => {
                  Setdoc("Personal")
