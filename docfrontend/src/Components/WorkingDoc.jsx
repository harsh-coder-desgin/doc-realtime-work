    ...
    <div>
      <div className="flex items-center gap-3 px-4 mt-2">
        ...
        <div className="relative" ref={ref}>
          ...
          {open && (
            <div className="absolute right-0 mt-2 w-[550px] h-140 bg-blue-900 border rounded-lg shadow-xl z-50">
              ...
              <div className="max-h-60 overflow-y-auto p-3 space-y-3 text-sm">
                ...
                <div className="flex justify-start">
                  <div className="bg-gray-100 px-3 py-2 rounded-lg max-w-[75%]">
                    Sure! Paste your resume section here.
                  </div>
                </div>
              </div>
